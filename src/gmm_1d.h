...
class gmm_1d {
 private:
  ...
  static constexpr double MIN_BD_THRESHOLD = 2.3025850929940455; // -log(d*) from Hennig et al. 2010
 ...
 public:
  ...
  int get_distinct_components_counts(const std::vector<int>& sites);

  bool fit(const std::vector<double>& x, const std::vector<int>& sites, std::vector<double>& logL_history, int n_iter = 20, unsigned int seed = 112358);
