...
int trim_bam_qual_primer(bool has_bam, std::string bam, std::string bed, std::string bam_out, std::string region, uint8_t min_qual, uint8_t sliding_window, std::string cmd, bool write_no_primer_reads, bool mark_qcfail_flag, int min_length, std::string pair_info, int32_t primer_offset);
