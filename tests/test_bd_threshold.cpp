...
//  double stdevs_diff[] = {0, 0.05, 0.075, 0.1};
  ...
  f << "mean1\tmean2\tstdev1\tstdev2\tnsamples\tsample\tvalue\tvalue_logit\n";

  std::ofstream fresults("/Users/karthik/tmp/test_bd_threshold/output/inferred_gmm.tsv", std::ios::out);
  fresults << "mean1\tmean2\tstdev1\tstdev2\tnsamples\tinferred_mean1_logit\tinferred_mean2_logit\tinferred_mean1\tinferred_mean2\tinferred_var1\tinferred_var2\tBD\tdistinct_components\n";
