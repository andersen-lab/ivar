...
int main() {
  int num_tests = 8;
  allele a1 = {"A", 40, 0, 30, 0, 0, 0, 0};
  allele a2 = {"T", 40, 10, 30, 0, 0, 0, 0};
  allele a3 = {"G", 40, 10, 10, 0, 0, 0, 0};
  allele a4 = {"+T", 30, 10, 10, 0, 0, 0, 0};
  allele a5 = {"+AG", 30, 10, 10, 0, 0, 0, 0};
  allele a6 = {"+AC", 30, 4, 10, 0, 0, 0, 0};
  allele a7 = {"+WT", 30, 2, 10, 0, 0, 0, 0};
  int success = 0;
  ...
  success += (s.q.compare("8++") == 0) ? 1 : 0;
  allele a8 = {"-AT", 10, 5, 20, 0, 0, 0, 0};
  allele a9 = {"-A", 10, 5, 20, 0, 0, 0, 0};
  allele a10 = {"-AG", 10, 5, 20, 0, 0, 0, 0};
  allele a11 = {"-AGT", 10, 5, 20, 0, 0, 0, 0};

  allele del_arr[] = {a8, a9, a10, a11};
  ret_t del_s;
  std::vector<allele> del_ad(del_arr,
                             del_arr + sizeof(del_arr) / sizeof(allele));
